...
def load_secondwindow():
    ...
    def searchbutton_func():

        search_movie()
        clear_searchbox()
        display_results_on_screen()
        add_to_watchlist_buttons()
    ...
    search_button = customtkinter.CTkButton(
        ...
        border_width=0,
        corner_radius=8,
        command=lambda: searchbutton_func()  #searches for movies, clears search engine, displays results, displays add buttons
    ).place(x=460, y=92)

    def clearbutton_func():
    ...
    clear_button = customtkinter.CTkButton(
        ...
        border_width=0,
        corner_radius=8,
        command=lambda: clearbutton_func()  #destroys previous entries in the recommmendation listbox widget in the gui
    ).place(x=545, y=90)

    #watchlist button
    watchlist_button = customtkinter.CTkButton(
        second_window,
        text="Watchlist",
        font=("Ubuntu", 15),
        text_color="white",
    ...
    to_search_history = customtkinter.CTkButton(
        second_window,
        text="Search History",
        font=("Ubuntu", 15),
        text_color="white",
...
def load_watchlistwindow():
    ...
    dequeue_watchlist = customtkinter.CTkButton(
        watchlist_window,
        text="Remove",
        font=("Ubuntu", 15),
        text_color="white",
    ...
    back_to_search_engine = customtkinter.CTkButton(
        watchlist_window,
        text="Search Engine",
        font=("Ubuntu", 15),
        text_color="white",
...
def load_historywindow():
    ...
    #loads search engine window
    to_search_engine = customtkinter.CTkButton(
        history_window,
        text="Search Engine",
        font=("Ubuntu", 15),
        text_color="white",
    ...
    pop_searchhistory = customtkinter.CTkButton(
        history_window,
        text="Delete",
        font=("Ubuntu", 15),
        text_color="white",
...
def load_registrationwindow():
    ...
    password_entry2 = tk.Entry(registration_window, font=("Shanti", 16), show ="*", textvariable=password_entry3)
    ...
    createacc_button = customtkinter.CTkButton(
        registration_window,
        text="Create account",
        font=("Ubuntu", 15),
        text_color="white",
